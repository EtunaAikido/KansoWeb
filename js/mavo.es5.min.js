...
"use strict";function _toConsumableArray(b){if(Array.isArray(b)){for(var c=0,d=Array(b.length);c<b.length;c++)d[c]=b[c];return d}return Array.from(b)}(function(b,c){var d=self.Mavo=b.Class({constructor:function(m){var n=this;this.treeBuilt=Mavo.defer(),this.element=m,this.inProgress=!1,this.index=Object.keys(d.all).length+1,Object.defineProperty(d.all,this.index-1,{value:this});var o=d.attributes.map(function(I){return"[data-"+I+"]"}).join(", ");if([this.element].concat(_toConsumableArray(c(o,this.element))).forEach(function(I){var L,J=!0,K=!1;try{for(var N,M=d.attributes[Symbol.iterator]();!(J=(N=M.next()).done);J=!0){var O=N.value,P=I.getAttribute("data-"+O);null!==P&&I.setAttribute(O,P)}}catch(Q){K=!0,L=Q}finally{try{!J&&M.return&&M.return()}finally{if(K)throw L}}}),this.id=Mavo.getAttribute(this.element,"mv-app","id")||"mavo"+this.index,this.id in d.all){for(var p=2;this.id+p in d.all;p++);this.id+=p}d.all[this.id]=this,this.element.setAttribute("mv-app",this.id);var q=b.value(this.element.closest("[lang]"),"lang")||Mavo.locale;this.locale=Mavo.Locale.get(q),this.autoEdit=this.element.classList.contains("mv-autoedit"),this.autoSave=this.element.hasAttribute("mv-autosave"),this.autoSaveDelay=1e3*(this.element.getAttribute("mv-autosave")||3),this.element.setAttribute("typeof",""),Mavo.hooks.run("init-start",this);var v,r=!0,u=!1;try{for(var x,w=c(d.selectors.primitive+","+d.selectors.multiple,this.element)[Symbol.iterator]();!(r=(x=w.next()).done);r=!0){var m=x.value,y=b(d.selectors.not(d.selectors.formControl)+", "+d.selectors.property,m);if(y){var z=Mavo.Primitive.getConfig(m),A=Mavo.is("multiple",m);!A&&(z.attribute||z.hasChildren)||m.setAttribute("typeof","")}}}catch(I){u=!0,v=I}finally{try{!r&&w.return&&w.return()}finally{if(u)throw v}}this.expressions=new Mavo.Expressions(this),Mavo.hooks.run("init-tree-before",this),this.root=new Mavo.Group(this.element,this),this.treeBuilt.resolve(),Mavo.hooks.run("init-tree-after",this),this.permissions=new Mavo.Permissions;var E,B=["source","storage","init"],C=!0,D=!1;try{for(var G,H,F=B[Symbol.iterator]();!(C=(G=F.next()).done);C=!0)H=G.value,this.updateBackend(H)}catch(I){D=!0,E=I}finally{try{!C&&F.return&&F.return()}finally{if(D)throw E}}this.backendObserver=new Mavo.Observer(this.element,B.map(function(I){return"mv-"+I}),function(I){var J={},K=I.map(function(L){var M=L.attributeName.replace(/^mv-/,"");return J[M]=n.updateBackend(M),M});J.source?n.load():!n.source&&(J.storage||J.init&&!n.root.data)&&n.load()}),this.permissions.can("login",function(){("login"in Mavo.Functions.$url&&1==n.index||n.id+"-login"in Mavo.Functions.$url)&&n.primaryBackend.login()}),this.element.addEventListener("mavo:login.mavo",function(I){I.backend!=(n.source||n.storage)||n.root.data||n.unsavedChanges||n.load()}),this.bar=new Mavo.UI.Bar(this),b("summary [property]:not([typeof])")&&this.element.addEventListener("click",function(I){I.target!=document.activeElement&&I.preventDefault()}),this.needsEdit=this.calculateNeedsEdit(),this.setUnsavedChanges(!1),this.permissions.onchange(function(I){var J=I.action,K=I.value,L=n.element.getAttribute("mv-permissions")||"";L=L.trim().split(/\s+/).filter(function(M){return M!=J}),K&&L.push(J),n.element.setAttribute("mv-permissions",L.join(" "))}),this.needsEdit&&this.permissions.can(["edit","add","delete"],function(){n.modeObserver=new Mavo.Observer(n.element,"mv-mode",function(I){var L,J=!0,K=!1;try{for(var N,M=I[Symbol.iterator]();!(J=(N=M.next()).done);J=!0){var O=N.value,P=O.target,Q=!0,R=!1,S=void 0;try{nodeloop:for(var U,T=d.Node.children(P)[Symbol.iterator]();!(Q=(U=T.next()).done);Q=!0){var V=U.value,W=V.mode,X=void 0;if(V.element==P)X=V.element.getAttribute("mv-mode"),V.modes=X;else{if(V.modes)continue nodeloop;X=d.getStyle(V.element.parentNode,"--mv-mode")}V.mode=X,W!=V.mode&&V["edit"==V.mode?"edit":"done"]()}}catch(Y){R=!0,S=Y}finally{try{!Q&&T.return&&T.return()}finally{if(R)throw S}}}}catch(Y){K=!0,L=Y}finally{try{!J&&M.return&&M.return()}finally{if(K)throw L}}},{subtree:!0}),n.autoEdit&&n.edit()},function(){n.modeObserver&&n.modeObserver.destroy()}),this.storage||this.source?this.permissions.can("read",function(){return n.load()}):requestAnimationFrame(function(){b.fire(n.element,"mavo:load")}),this.permissions.can("save",function(){n.autoSave&&n.element.addEventListener("mavo:load.mavo:autosave",function(){var J=d.debounce(function(){n.save()},n.autoSaveDelay),K=function(M){M.node.saved&&J()};requestAnimationFrame(function(){n.permissions.can("save",function(){n.element.addEventListener("mavo:datachange.mavo:autosave",K)},function(){n.element.removeEventListener("mavo:datachange.mavo:autosave",K)})})})},function(){b.unbind(n.element,".mavo:save .mavo:autosave")}),this.element.addEventListener("keydown",function(I){if(n.permissions.save&&83==I.keyCode&&I[d.superKey]&&!I.altKey)I.preventDefault(),n.save();else if(38==I.keyCode||40==I.keyCode){var J=I.target;if(J.matches("textarea, input[type=range], input[type=number]"))return;if(J.matches(".mv-editor")){J=J.parentNode}var L=Mavo.Node.get(J);if(L&&L.closestCollection){var M=L.getCousin(38==I.keyCode?-1:1,{wrap:!0});M&&(M.editing?M.edit({immediately:!0}).then(function(){return M.editor.focus()}):M.element.focus(),I.preventDefault())}}}),Mavo.hooks.run("init-end",this)},get editing(){return this.root.editing},getData:function(){return this.root.getData()},toJSON:function(){return d.toJSON(this.getData())},message:function(m,n){return new d.UI.Message(this,m,n)},error:function(m){this.message(m,{type:"error",dismiss:["button","timeout"]});for(var n=arguments.length,o=Array(1<n?n-1:0),p=1;p<n;p++)o[p-1]=arguments[p];if(0<o.length){var q;(q=console).log.apply(q,["%c"+this.id+": "+m,"color: red; font-weight: bold"].concat(o))}},render:function(m){var n=this;this.expressions.active=!1;var o={context:this,data:m};d.hooks.run("render-start",o),o.data&&this.root.render(o.data),this.unsavedChanges=!1,this.expressions.active=!0,requestAnimationFrame(function(){return n.expressions.update()}),d.hooks.run("render-end",o)},clear:function(){var m=this;confirm(this._("delete-confirmation"))&&this.store(null).then(function(){return m.root.clear()})},edit:function(){this.root.edit(),b.events(this.element,"mouseenter.mavo:edit mouseleave.mavo:edit",function(m){if(m.target.matches(d.selectors.multiple)){m.target.classList.remove("mv-has-hovered-item");var n=m.target.parentNode.closest(d.selectors.multiple);n&&n.classList.toggle("mv-has-hovered-item","mouseenter"==m.type)}},!0),this.setUnsavedChanges()},setUnsavedChanges:function(m){var n=!!m;return m||this.walk(function(o){if(o.unsavedChanges)return n=!0,!1===m&&(o.unsavedChanges=!1),!1}),this.unsavedChanges=n},done:function(){this.root.done(),b.unbind(this.element,".mavo:edit"),this.unsavedChanges=!1},updateBackend:function(m){var o,n=this[m];1==this.index&&(o=d.Functions.$url[m]),o||(o=d.Functions.$url[this.id+"-"+m]||this.element.getAttribute("mv-"+m)||null),o&&(o=o.trim(),"none"==o&&(o=null)),!o||n&&n.equals(o)?!o&&(this[m]=null):this[m]=o=d.Backend.create(o,{mavo:this,format:this.element.getAttribute("mv-"+m+"-format")||this.element.getAttribute("mv-format")},this.element.getAttribute("mv-"+m+"-type"));var p=o?!o.equals(n):!!n;if(p){this.storage||this.source||!this.init||(this.source=this.init,this.init=null);var q=this.storage?this.storage.permissions:new Mavo.Permissions({edit:!0,save:!1});q.parent=this.source&&this.source.permissions,this.permissions.parent=q,this.primaryBackend=this.storage||this.source}return p},load:function(){var m=this,n=this.source||this.storage;return n?(this.inProgress="Loading",n.ready.then(function(){return n.load()}).catch(function(o){return m.init&&m.init!=n?(n=m.init,m.init.ready.then(function(){return m.init.load()})):Promise.reject(o)}).catch(function(o){if(o){var p=o instanceof XMLHttpRequest?o:o.xhr;if(p&&404==p.status)m.render(null);else{var q="Problem loading data";p&&(q+=p.status?": HTTP error "+o.status+": "+o.statusText:": Can\u2019t connect to the Internet"),m.error(q,o)}}return null}).then(function(o){return m.render(o)}).then(function(){m.inProgress=!1,b.fire(m.element,"mavo:load")})):Promise.resolve()},store:function(){var m=this;return this.storage?(this.inProgress="Saving",this.storage.store(this.getData()).catch(function(n){if(n){var o=m._("problem-saving");n instanceof XMLHttpRequest&&(o+=": "+(n.status?m._("http-error",n):m._("cant-connect"))),m.error(o,n)}return null}).then(function(n){return m.inProgress=!1,n})):Promise.resolve()},upload:function(m){var n=this,o=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"images/"+m.name;return this.uploadBackend?(this.inProgress=this._("uploading"),this.uploadBackend.upload(m,o).then(function(p){return n.inProgress=!1,p}).catch(function(p){return n.error(n._("error-uploading"),p),n.inProgress=!1,null})):Promise.reject()},save:function(){var m=this;return this.store().then(function(n){n&&(b.fire(m.element,"mavo:save",n),m.lastSaved=Date.now(),m.root.save(),m.unsavedChanges=!1)})},walk:function(m){return this.root.walk(m)},calculateNeedsEdit:function(){var n=!1;return this.walk(function(o){return!n&&(n=!o.modes&&"Group"!=o.nodeType,!o.modes||void 0)},void 0,{descentReturn:!0}),n},live:{inProgress:function(m){b.toggleAttribute(this.element,"mv-progress",m,m),b.toggleAttribute(this.element,"aria-busy",!!m,!!m),this.element.style.setProperty("--mv-progress-text",m?"\""+this._(m)+"\"":"")},unsavedChanges:function(m){this.element.classList.toggle("mv-unsaved-changes",m)},needsEdit:function(m){this.bar.toggle("edit",m&&this.permissions.edit)},storage:function(m){if(m!==this._storage&&!m){var n=new Mavo.Permissions({edit:!0,save:!1});n.parent=this.permissions.parent,this.permissions.parent=n}},primaryBackend:function(m){if(m=m||null,m!=this._primaryBackend)return m?this.element.style.setProperty("--mv-backend","\""+m.id+"\""):this.element.style.removeProperty("--mv-backend"),m},uploadBackend:{get:function(){if(this.storage&&this.storage.upload)return this.storage}}},static:{all:{},get:function(m){if(m instanceof Element){for(var n in d.all)if(d.all[n].element==m)return d.all[n];return null}var n="number"==typeof m?Object.keys(d.all)[m]:m;return d.all[n]||null},superKey:0===navigator.platform.indexOf("Mac")?"metaKey":"ctrlKey",base:"about:"==location.protocol?document.currentScript?document.currentScript.src:"http://mavo.io":location,dependencies:[],init:function(){var m=0<arguments.length&&arguments[0]!==void 0?arguments[0]:document,n=Array.isArray(arguments[0])?arguments[0]:c(d.selectors.init,m);return n.filter(function(o){return!d.get(o)}).map(function(o){return new d(o)})},UI:{},hooks:new b.Hooks,attributes:["mv-app","mv-storage","mv-source","mv-init","mv-path","mv-format","mv-attribute","mv-default","mv-mode","mv-edit","mv-permisssions","mv-rel"],lazy:{locale:function(){return document.documentElement.lang||"en-GB"}}}});Object.defineProperty(d.all,"length",{get:function(){return Object.keys(this).length}});{var e=d.selectors={init:".mv-app, [mv-app], [data-mv-app]",property:"[property], [itemprop]",specificProperty:function(m){return"[property="+m+"], [itemprop="+m+"]"},group:"[typeof], [itemscope], [itemtype], [mv-group]",multiple:"[mv-multiple]",formControl:"input, select, option, textarea",textInput:["text","email","url","tel","search"].map(function(l){return"input[type="+l+"]"}).join(", ")+", input:not([type]), textarea",ui:".mv-ui",container:{tr:"table",option:"select"}},f=e.arr=function(l){return l.split(/\s*,\s*/g)},g=e.not=function(l){return f(l).map(function(m){return":not("+m+")"}).join("")},h=e.or=function(l,m){return l+", "+m},j=e.and=function(l,m){var n=[],o=f(m);return f(l).forEach(function(p){return n.push.apply(n,_toConsumableArray(o.map(function(q){return p+q})))}),n.join(", ")},k=e.andNot=function(l,m){return j(l,g(m))};b.extend(d.selectors,{primitive:k(e.property,e.group),rootGroup:k(e.group,e.property),item:h(e.multiple,e.group),output:h(e.specificProperty("output"),".mv-output")})}requestAnimationFrame(function(){var l=[];b.each({blissfuljs:Array.from&&document.documentElement.closest&&self.URL&&"searchParams"in URL.prototype,"Intl.~locale.en":self.Intl,IntersectionObserver:self.IntersectionObserver},function(m,n){n||l.push(m)}),d.dependencies.push(b.ready(),d.Plugins.load(),b.include(!l.length,"https://cdn.polyfill.io/v2/polyfill.min.js?features="+l.join(","))),d.inited=b.ready().then(function(){return b.attributes(c(d.selectors.init),{"mv-progress":"Loading"}),d.ready}).catch(console.error).then(function(){return Mavo.init()}),d.ready=d.thenAll(d.dependencies)}),Stretchy.selectors.filter=".mv-editor:not([property]), .mv-autosize"})(Bliss,Bliss.$);
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(b){return typeof b}:function(b){return b&&"function"==typeof Symbol&&b.constructor===Symbol&&b!==Symbol.prototype?"symbol":typeof b};function _toConsumableArray(b){if(Array.isArray(b)){for(var d=0,e=Array(b.length);d<b.length;d++)e[d]=b[d];return e}return Array.from(b)}(function(b,d){function e(h,k){for(h="mv-"+h+"-within",d("."+h).forEach(function(l){return l.classList.remove(h)});k&&k.classList;)k.classList.add(h),k=k.parentNode}var g=b.extend(Mavo,{load:function(k){var l=1<arguments.length&&void 0!==arguments[1]?arguments[1]:document.currentScript?document.currentScript.src:location;if(g.loaded=g.loaded||new Set,!g.loaded.has(k+""))return k=new URL(k,l),/\.css$/.test(k.pathname)?(b.create("link",{href:k,rel:"stylesheet",inside:document.head}),Promise.resolve()):b.include(k)},readFile:function(k){var l=1<arguments.length&&arguments[1]!==void 0?arguments[1]:"DataURL",m=new FileReader;return new Promise(function(n,q){m.onload=function(){return n(m.result)},m.onerror=m.onabort=q,m["readAs"+l](k)})},toJSON:function(k){return null===k?"":"string"==typeof k?k:JSON.stringify(k,null,"\t")},safeToJSON:function(k){var l=new WeakSet;return JSON.stringify(k,function(m,n){if("object"===("undefined"==typeof n?"undefined":_typeof(n))&&null!==n){if(l.has(n))return;l.add(n)}return n})},toArray:function(k){return k===void 0?[]:Array.isArray(k)?k:[k]},delete:function(k,l,m){do{var n=k&&k.indexOf(l);-1<n&&k.splice(n,1)}while(-1<n&&m)},flatten:function(k){return Array.isArray(k)?k.reduce(function(l,m){return g.toArray(l).concat(g.flatten(m))},[]):[k]},pushUnique:function(k,l){-1===k.indexOf(l)&&k.push(l)},union:function(k,l){return new Set([].concat(_toConsumableArray(k||[]),_toConsumableArray(l||[])))},is:function(k){for(var l=arguments.length,m=Array(1<l?l-1:0),n=1;n<l;n++)m[n-1]=arguments[n];var q=!0,t=!1,u;try{for(var w,x,v=m[Symbol.iterator]();!(q=(w=v.next()).done);q=!0)if(x=w.value,x&&x.matches&&x.matches(g.selectors[k]))return!0}catch(y){t=!0,u=y}finally{try{!q&&v.return&&v.return()}finally{if(t)throw u}}return!1},getStyle:function(k,l){return k&&getComputedStyle(k).getPropertyValue(l).trim()},data:function(k,l,m){return 2==arguments.length?b.value(k,"_","data","mavo",l):(k._.data.mavo=k._.data.mavo||{},void 0===m)?void delete k._.data.mavo[l]:k._.data.mavo[l]=m},elementPath:function(k,l){var m=2<arguments.length&&arguments[2]!==void 0?arguments[2]:[1,3],n=1===m.length&&1==m[0];if(Array.isArray(l)){var q=l;return q.reduce(function(w,x){if(n)var y=w.children;else var y=d(w.childNodes).filter(function(z){return-1<m.indexOf(z.nodeType)});return y[x]},k)}for(var q=[],t=l;t&&t!=k;t=t.parentNode){for(var u=0,v=t;v=v["previous"+(n?"Element":"")+"Sibling"];)-1<m.indexOf(v.nodeType)&&u++;q.unshift(u)}return t?q:null},revocably:{add:function(k,l){var m=g.revocably.isRemoved(k);return m&&m.parentNode?m.parentNode.replaceChild(k,m):k&&l&&!k.parentNode&&l.appendChild(k),m},remove:function(k,l){if(k){var m=g.data(k,"commentstub");return m||(l=l||k.id||k.className||k.nodeName,m=g.data(k,"commentstub",document.createComment(l))),k.parentNode&&k.parentNode.replaceChild(m,k),m}},isRemoved:function(k){if(!k||k.parentNode)return!1;var l=g.data(k,"commentstub");return l&&l.parentNode&&l},setAttribute:function(k,l,m){var n=g.data(k,"attribute-"+l);n===void 0&&g.data(k,"attribute-"+l,k.getAttribute(l)),k.setAttribute(l,m)},restoreAttribute:function(k,l){var m=g.data(k,"attribute-"+l);m!==void 0&&(b.toggleAttribute(k,l,m),g.data(k,"attribute-"+l,void 0))}},inView:{is:function(k){var l=k.getBoundingClientRect();return(0<=l.bottom&&l.bottom<=innerHeight||0<=l.top&&l.top<=innerHeight)&&(0<=l.right&&l.right<=innerWidth||0<=l.left&&l.left<=innerWidth)},when:function(k){var l=g.inView.observer=g.inView.observer||new IntersectionObserver(function(m){var n=!0,q=!1,t;try{for(var v,w,u=m[Symbol.iterator]();!(n=(v=u.next()).done);n=!0)w=v.value,this.unobserve(w.target),b.fire(w.target,"mavo:inview",{entry:w})}catch(x){q=!0,t=x}finally{try{!n&&u.return&&u.return()}finally{if(q)throw t}}});return new Promise(function(m){g.is(k)&&m(),l.observe(k);k.addEventListener("mavo:inview",function q(t){k.removeEventListener("mavo:inview",q),t.stopPropagation(),m()})})}},scrollIntoViewIfNeeded:function(k){k&&!Mavo.inView.is(k)&&k.scrollIntoView({behavior:"smooth"})},setAttributeShy:function(k,l,m){k.hasAttribute(l)||k.setAttribute(l,m)},getAttribute:function(k){for(var l=arguments.length,m=Array(1<l?l-1:0),n=1;n<l;n++)m[n-1]=arguments[n];for(var t,u,q=0;t=m[q];q++)if(u=k.getAttribute(t),u)return u;return null},getTarget:function(){var k=location.hash.substr(1);return document.getElementById(k)},in:function(k,l){if(k)return"object"===("undefined"==typeof k?"undefined":_typeof(k))&&l in k||void 0!==k[l]},getCanonicalProperty:function(k,l){if(k&&l){if(g.in(k,l))return l;if(l.toLowerCase){var m=l.toLowerCase();if(g.in(k,m))return m;var n=Object.keys(k),q=n.map(function(t){return t.toLowerCase()}).indexOf(m);if(-1<q)return n[q]}}},subset:function(k,l,m){if(3==arguments.length){if(l.length){var n=b.value.apply(b,[k].concat(_toConsumableArray(l.slice(0,-1))));return n[l[l.length-1]]=m,k}return m}return"object"==("undefined"==typeof k?"undefined":_typeof(k))&&l&&l.length?l.reduce(function(q,t,u){if(q&&t in q)return q[t];if(Array.isArray(q)&&isNaN(t))for(var v=0;v<q.length;v++)if(q[v]&&q[v].id==t)return l[u]=v,q[v];return q},k):k},clone:function(k){return JSON.parse(g.safeToJSON(k))},debounce:function(k,l){if(!l)return k;var n,m=null;return function(){var q=this,t=arguments;n=function(){k.apply(q,t),removeEventListener("beforeunload",n)},clearTimeout(m),m=setTimeout(n,l),addEventListener("beforeunload",n)}},timeout:function(k){return new Promise(function(l){return setTimeout(l,k)})},escapeRegExp:function(k){return k.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")},matches:function(k,l){var m=(k+"").match(l);return m?m:[]},match:function(k,l){var m=2<arguments.length&&arguments[2]!==void 0?arguments[2]:0;return g.matches(k,l)[m]||""},observeResize:function(k,l){if(self.ResizeObserver){var m=null,n=l instanceof ResizeObserver?l:new ResizeObserver(function(q){var t=q[q.length-1].contentRect;m&&m.width==t.width&&m.height==t.height||(l(q),m=t)});return n.observe(k),n}},Observer:b.Class({constructor:function(k,l,m){var n=3<arguments.length&&arguments[3]!==void 0?arguments[3]:{};m instanceof MutationObserver&&(this.observer=m),this.observer=this.observer||new MutationObserver(m),this.element=k,this.callback=m,this.attribute=l,this.options=b.extend({},n),l&&b.extend(this.options,{attributes:!0,attributeFilter:"all"==this.attribute?void 0:Mavo.toArray(this.attribute),attributeOldValue:!!n.oldValue}),this.attribute&&"all"!=this.attribute||b.extend(this.options,{characterData:!0,childList:!0,subtree:!0,characterDataOldValue:!!n.oldValue}),this.run()},stop:function(){return this.observer.disconnect(),this.running=!1,this},run:function(){return this.observer&&(this.observer.observe(this.element,this.options),this.running=!0),this},sneak:function(k){if(this.running){this.stop();var l=k();this.run()}else var l=k();return l},destroy:function(){this.observer.disconnect(),this.observer=this.element=null},static:{sneak:function(k,l){return k?k.sneak(l):l()}}}),defer:function(k){var l,m,n=new Promise(function(q,t){k&&k(q,t),l=q,m=t});return n.resolve=function(q){return l(q),n},n.reject=function(q){return m(q),n},n},thenAll:function(k){var l=!0,m=!1,n;try{for(var t,u,q=k[Symbol.iterator]();!(l=(t=q.next()).done);l=!0)u=t.value,"promise"==b.type(u)&&(u=u.catch(function(v){return v}))}catch(v){m=!0,n=v}finally{try{!l&&q.return&&q.return()}finally{if(m)throw n}}return Promise.all(k).then(function(v){return k.length==v.length?v:g.thenAll(k)})},rr:function(k){return k(),k},wrap:function(k,l){return 0>k?l-1:k>=l?0:k}});b.add("toggleAttribute",function(h,k){var l=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null!==k;l?this.setAttribute(h,k):this.removeAttribute(h)}),b.proxy=b.classProps.proxy=b.overload(function(h,k,l){return Object.defineProperty(h,k,{get:function(){return this[l][k]},set:function(n){this[l][k]=n},configurable:!0,enumerable:!0}),h}),b.classProps.propagated=function(h,k){Mavo.toArray(k).forEach(function(l){var m=h[l];h[l]=function(){var n=m&&m.apply(this,arguments);this.propagate&&!1!==n&&this.propagate(l)}})};document.addEventListener("focus",function(h){e("focus",h.target)},!0),document.addEventListener("blur",function(){e("focus",null)},!0),addEventListener("hashchange",function(){e("target",g.getTarget())}),document.documentElement.addEventListener("mavo:datachange",function(){e("target",g.getTarget())}),e("focus",document.activeElement===document.body?null:document.activeElement)})(Bliss,Bliss.$);
...
"use strict";function _toConsumableArray(a){if(Array.isArray(a)){for(var b=0,c=Array(a.length);b<a.length;b++)c[b]=a[b];return c}return Array.from(a)}(function(a){Mavo.attributes.push("mv-expressions");var b=Mavo.Expression=a.Class({constructor:function(d){this.expression=d},eval:function(d){this.oldValue=this.value,Mavo.hooks.run("expression-eval-beforeeval",this);try{this.function||(this.function=b.compile(this.expression),this.identifiers=this.expression.match(/[$a-z][$\w]*/ig)||[]),this.value=this.function(d)}catch(f){console.info("%cExpression error!","color: red; font-weight: bold",f.message+" in expression "+this.expression,"\nNot an expression? Use mv-expressions=\"none\" to disable expressions on an element and its descendants."),Mavo.hooks.run("expression-eval-error",{context:this,exception:f}),this.value=f}return this.value},toString:function(){return this.expression},changedBy:function(d){if(!d)return!0;if(!this.identifiers)return!1;if(-1<this.identifiers.indexOf(d.property))return!0;if(Mavo.Functions.intersects(d.properties,this.identifiers))return!0;if("propertychange"!=d.action){if(Mavo.Functions.intersects(["$index","$previous","$next"],this.identifiers))return!0;var f=d.node.collection||d.node;if(Mavo.Functions.intersects(f.properties,this.identifiers))return!0}return!1},live:{expression:function(d){d=d;this.function=null}},static:{serializers:{BinaryExpression:function(d){return b.serialize(d.left)+" "+d.operator+" "+b.serialize(d.right)},UnaryExpression:function(d){return""+d.operator+b.serialize(d.argument)},CallExpression:function(d){return b.serialize(d.callee)+"("+d.arguments.map(b.serialize).join(", ")+")"},ConditionalExpression:function(d){return b.serialize(d.test)+"? "+b.serialize(d.consequent)+" : "+b.serialize(d.alternate)},MemberExpression:function(d){return"get("+b.serialize(d.object)+", \""+(d.property.name||d.property.value)+"\")"},ArrayExpression:function(d){return"["+d.elements.map(b.serialize).join(", ")+"]"},Literal:function(d){return d.raw},Identifier:function(d){return d.name},ThisExpression:function(){return"this"},Compound:function(d){return d.body.map(b.serialize).join(" ")}},transformations:{BinaryExpression:function(d){var f=Mavo.Script.getOperatorName(d.operator),g=Mavo.Script.operators[f],h=d,j=[];do j.unshift(h.right),h=h.left;while(Mavo.Script.getOperatorName(h.operator)===f);if(j.unshift(h),1<j.length)return f+"("+j.map(b.serialize).join(", ")+")"},CallExpression:function(d){"Identifier"==d.callee.type&&("if"==d.callee.name&&(d.callee.name="iff"),d.callee.name="Mavo.Functions._Trap."+d.callee.name)}},serialize:function(d){if(b.transformations[d.type]){var f=b.transformations[d.type](d);if(f!==void 0)return f}return b.serializers[d.type](d)},rewrite:function(d){try{return b.serialize(b.parse(d))}catch(f){return d}},compile:function(d){return d=b.rewrite(d),new Function("data","with(Mavo.Functions._Trap)\n\t\t\t\t\twith (data || {}) {\n\t\t\t\t\t\treturn "+d+";\n\t\t\t\t\t}")},parse:self.jsep}});self.jsep&&(jsep.addBinaryOp("and",2),jsep.addBinaryOp("or",2),jsep.addBinaryOp("=",6),jsep.addBinaryOp("mod",10),jsep.removeBinaryOp("===")),b.serializers.LogicalExpression=b.serializers.BinaryExpression,b.transformations.LogicalExpression=b.transformations.BinaryExpression,b.Syntax=a.Class({constructor:function(d,f){this.start=d,this.end=f,this.regex=RegExp(Mavo.escapeRegExp(d)+"([\\S\\s]+?)"+Mavo.escapeRegExp(f),"gi")},test:function(d){return this.regex.lastIndex=0,this.regex.test(d)},tokenize:function(d){var f,g=[],h=0;for(this.regex.lastIndex=0;null!==(f=this.regex.exec(d));)f.index>h&&g.push(d.substring(h,f.index)),h=this.regex.lastIndex,g.push(new Mavo.Expression(f[1]));return h<d.length&&g.push(d.substring(h)),g},static:{create:function(d){if(d){var f=d.getAttribute("mv-expressions");if(f)return f=f.trim(),/\s/.test(f)?new(Function.prototype.bind.apply(b.Syntax,[null].concat(_toConsumableArray(f.split(/\s+/))))):b.Syntax.ESCAPE}},ESCAPE:-1}}),b.Syntax.default=new b.Syntax("[","]")})(Bliss);
"use strict";function _toConsumableArray(a){if(Array.isArray(a)){for(var b=0,c=Array(a.length);b<a.length;b++)c[b]=a[b];return c}return Array.from(a)}(function(a){var b=Mavo.DOMExpression=a.Class({constructor:function(){var d=this,e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};this.mavo=e.mavo,this.template=e.template&&e.template.template||e.template;for(var h,f=["item","path","syntax","fallback","attribute","originalAttribute","expression","parsed"],g=0;g<f.length;g++)h=f[g],this[h]=void 0===e[h]&&this.template?this.template[h]:e[h];if(this.node=e.node,this.node||(this.node=Mavo.elementPath(this.item.element,this.path)),this.element=this.node,this.attribute=this.attribute||null,Mavo.hooks.run("domexpression-init-start",this),3===this.node.nodeType&&this.element===this.node&&(this.element=this.node.parentNode,(!this.node.parentNode.children.length||this.attribute)&&(this.node=this.element,this.element.normalize())),!this.expression){if(this.attribute)this.expression=this.node.getAttribute(this.attribute).trim();else{if(this.node.normalize(),this.node.firstChild&&1===this.node.childNodes.length&&3===this.node.firstChild.nodeType){var j=this.node.firstChild.textContent.match(/^\s*|\s*$/g);j[1]&&(this.node.firstChild.splitText(this.node.firstChild.textContent.length-j[1].length),a.after(this.node.lastChild,this.node)),j[0]&&(this.node.firstChild.splitText(j[0].length),this.node.parentNode.insertBefore(this.node.firstChild,this.node))}this.expression=this.node.textContent}this.parsed=e.template?e.template.parsed:this.syntax.tokenize(this.expression)}this.oldValue=this.value=this.parsed.map(function(k){return k instanceof Mavo.Expression?k.expression:k}),this.item=Mavo.Node.get(this.element.closest(Mavo.selectors.item)),this.mavo.treeBuilt.then(function(){d.template||d.item||(d.item=Mavo.Node.get(d.element.closest(Mavo.selectors.item))),Mavo.hooks.run("domexpression-init-treebuilt",d)}),Mavo.hooks.run("domexpression-init-end",this),b.elements.set(this.element,[].concat(_toConsumableArray(b.elements.get(this.element)||[]),[this]))},changedBy:function(d){return!this.parsed.every(function(e){return!(e instanceof Mavo.Expression)||!e.changedBy(d)})},update:function(){var d=this,e=0<arguments.length&&arguments[0]!==void 0?arguments[0]:this.data,f=arguments[1],g={context:this,event:f},h=g;this.data=e,Mavo.hooks.run("domexpression-update-start",g),this.oldValue=this.value,g.value=this.value=this.parsed.map(function(j,k){if(j instanceof Mavo.Expression){if(j.changedBy(h.event)){var l={context:d,expr:j,parentEnv:h};return Mavo.hooks.run("domexpression-update-beforeeval",l),l.value=l.expr.eval(e),Mavo.hooks.run("domexpression-update-aftereval",l),l.value instanceof Error?void 0===d.fallback?d.syntax.start+l.expr.expression+d.syntax.end:d.fallback:void 0===l.value||null===l.value?"":l.value}return d.oldValue[k]}return j}),g.value=1===g.value.length?g.value[0]:g.value.map(Mavo.Primitive.format).join(""),this.output(g.value),Mavo.hooks.run("domexpression-update-end",g)},output:function(d){this.primitive?this.primitive.value=d:Mavo.Primitive.setValue(this.node,d,{attribute:this.attribute})},live:{item:function(d){d&&this._item!=d&&(this._item&&Mavo.delete(this._item.expressions,this),d.expressions=d.expressions||[],d.expressions.push(this))}},static:{elements:new WeakMap,search:function(d,e){var f=b.elements.get(d)||[];return 1<arguments.length?f.length?f.filter(function(g){return g.attribute===e})[0]||null:null:f}}})})(Bliss);
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"==typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a};function _defineProperty(a,b,c){return b in a?Object.defineProperty(a,b,{value:c,enumerable:!0,configurable:!0,writable:!0}):a[b]=c,a}function _toConsumableArray(a){if(Array.isArray(a)){for(var b=0,c=Array(a.length);b<a.length;b++)c[b]=a[b];return c}return Array.from(a)}(function(a,b){var c=Mavo.Expressions=a.Class({constructor:function(e){var f=this;this.mavo=e,this.active=!0,this.expressions=[];var g=Mavo.Expression.Syntax.create(this.mavo.element.closest("[mv-expressions]"))||Mavo.Expression.Syntax.default;this.traverse(this.mavo.element,void 0,g),this.scheduled={},this.mavo.treeBuilt.then(function(){f.expressions=[],document.documentElement.addEventListener("mavo:datachange",function(h){if(f.active){var j=f.scheduled[h.action]=f.scheduled[h.action]||new Set;h.node.closestCollection||h.mavo!=f.mavo?!j.has(h.property)&&(setTimeout(function(){j.delete(h.property),f.update(h)},c.THROTTLE),j.add(h.property)):requestAnimationFrame(function(){return f.update(h)})}}),f.update()})},update:function(e){if(this.active){var f,g;e instanceof Mavo.Node?(g=e,e=null):e instanceof Element?(f=e.closest(Mavo.selectors.item),g=Mavo.Node.get(f),e=null):g=this.mavo.root;var h=g.getData({live:!0});g.walk(function(j,k){if(j.expressions&&j.expressions.length&&!j.isDeleted()){var l=a.value.apply(a,[h].concat(_toConsumableArray(k)));if("object"!=("undefined"==typeof l?"undefined":_typeof(l))||null===l){var m,n=a.value.apply(a,[h].concat(_toConsumableArray(k.slice(0,-1))));l=(m={},_defineProperty(m,Symbol.toPrimitive,function(){return l}),_defineProperty(m,j.property,l),m),self.Proxy&&(l=j.relativizeData(l))}var r,p=!0,q=!1;try{for(var t,u,s=j.expressions[Symbol.iterator]();!(p=(t=s.next()).done);p=!0)u=t.value,u.changedBy(e)&&u.update(l,e)}catch(v){q=!0,r=v}finally{try{!p&&s.return&&s.return()}finally{if(q)throw r}}}})}},extract:function(e,f,g){var h=3<arguments.length&&arguments[3]!==void 0?arguments[3]:Mavo.Expression.Syntax.default;f&&"mv-expressions"==f.name||(g=void 0===g?Mavo.elementPath(e.closest(Mavo.selectors.item),e):g&&"string"==typeof g?g.slice(1).split("/").map(function(j){return+j}):[],(f&&-1<c.directives.indexOf(f.name)||h.test(f?f.value:e.textContent))&&this.expressions.push(new Mavo.DOMExpression({node:e,syntax:h,path:g,attribute:f&&f.name,mavo:this.mavo})))},traverse:function(e){var f=this,g=1<arguments.length&&arguments[1]!==void 0?arguments[1]:"",h=arguments[2];if(8!==e.nodeType)if(3===e.nodeType)this.extract(e,null,g,h);else{if(e.normalize(),h=Mavo.Expression.Syntax.create(e)||h,h===Mavo.Expression.Syntax.ESCAPE)return;Mavo.is("item",e)&&(g=""),b(e.attributes).forEach(function(k){return f.extract(e,k,g,h)});var j=0;b(e.childNodes).forEach(function(k){(1==k.nodeType||3==k.nodeType)&&(f.traverse(k,g+"/"+j,h),j++)})}},static:{directives:[],THROTTLE:50,directive:function(e,f){c.directives.push(e),Mavo.attributes.push(e),Mavo.Plugins.register(e,f)}}});self.Proxy&&Mavo.hooks.add("node-getdata-end",function(d){if(d.options.live&&(d.data||0===d.data||""===d.data)&&"object"===_typeof(d.data)){var e=d.data;d.data=this.relativizeData(e)}})})(Bliss,Bliss.$);
...
"use strict";function _toConsumableArray(a){if(Array.isArray(a)){for(var b=0,c=Array(a.length);b<a.length;b++)c[b]=a[b];return c}return Array.from(a)}Mavo.Expressions.directive("mv-value",{hooks:{"node-init-start":function(){if(this instanceof Mavo.Group||this.collection){var b=Mavo.DOMExpression.search(this.element).filter(function(c){return"mv-value"==c.originalAttribute})[0];b&&(b.mavoNode=this,this.expressionText=b,this.storage=this.storage||"none",this.modes="read",this.collection&&(this.collection.expressions=[].concat(_toConsumableArray(this.collection.expressions||[]),[b]),b.mavoNode=this.collection,this.collection.storage=this.collection.storage||"none",this.collection.modes="read"))}},"domexpression-init-start":function(){"mv-value"!=this.attribute||(this.originalAttribute="mv-value",this.attribute=Mavo.Primitive.getValueAttribute(this.element),this.fallback=this.fallback||Mavo.Primitive.getValue(this.element,{attribute:this.attribute}),this.expression=this.element.getAttribute("mv-value"),this.element.removeAttribute("mv-value"),this.parsed=[new Mavo.Expression(this.expression)],this.expression=this.syntax.start+this.expression+this.syntax.end)},"domexpression-init-treebuilt":function(){"mv-value"==this.originalAttribute&&this.mavoNode&&(this.mavoNode==this.item||this.mavoNode==this.item.collection)&&(this.mavoNode==this.item.collection&&Mavo.delete(this.item.expressions,this),this.output=function(b){b=b.value||b,this.mavoNode.render(b)},this.changedBy=function(){return!0})}}});
"use strict";var _slicedToArray=function(){function f(g,h){var j=[],k=!0,l=!1,m;try{for(var s,q=g[Symbol.iterator]();!(k=(s=q.next()).done)&&(j.push(s.value),!(h&&j.length===h));k=!0);}catch(t){l=!0,m=t}finally{try{!k&&q["return"]&&q["return"]()}finally{if(l)throw m}}return j}return function(g,h){if(Array.isArray(g))return g;if(Symbol.iterator in Object(g))return f(g,h);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(f){return typeof f}:function(f){return f&&"function"==typeof Symbol&&f.constructor===Symbol&&f!==Symbol.prototype?"symbol":typeof f};function _defineProperty(f,g,h){return g in f?Object.defineProperty(f,g,{value:h,enumerable:!0,configurable:!0,writable:!0}):f[g]=h,f}function _toConsumableArray(f){if(Array.isArray(f)){for(var g=0,h=Array(f.length);g<f.length;g++)h[g]=f[g];return h}return Array.from(f)}(function(f){function g(y,z){return y=Array.isArray(y)?y:z?$$(z):[y],y.filter(function(A){return!isNaN(A)&&""!==A}).map(function(A){return+A})}function h(){var y=0<arguments.length&&void 0!==arguments[0]?arguments[0]:"";return y||0===y?y+"":""}function j(y){if(!y)return null;if("string"===f.type(y)){y=y.trim(),/^\d{4}-\d{2}-\d{2}/.test(y)||(y=m.$today+" "+y),-1===y.indexOf(":")?y+="T00:00:00":y=y.replace(/\-(\d{2})\s+(?=\d{2}:)/,"-$1T"),y=y.replace(/\s+/g,"");var z=Mavo.match(y,/[+-]\d{2}:?\d{2}|Z$/);if(z)y=new Date(y);else{var A=y.match(/\d+/g);y=new Date(A[0],(A[1]||1)-1,A[2]||1,A[3]||0,A[4]||0,A[5]||0,A[6]||0)}}else y=new Date(y);return isNaN(y)?null:y}function k(y,z){var A=y.toLocaleString(Mavo.locale,z);return A=A.replace(/\u200e/g,""),A}function l(y){return function(z){if(z=j(z),!z)return"";var A=x[y](z);return A=new self["year"==y?"String":"Number"](A),("month"==y||"weekday"==y)&&(A.name=k(z,_defineProperty({},y,"long")),A.shortname=k(z,_defineProperty({},y,"short"))),"weekday"!=y&&(A.twodigit=(10>A?"0":"")+(1>A?"0":"")+A%100),A}}var m=Mavo.Functions={operators:{"=":"eq"},get:function(z,A){var B=Mavo.getCanonicalProperty(z,A);if(B){var C=z[B];return"function"==typeof C?C.bind(z):C}if(Array.isArray(z)&&isNaN(A)){var F,D=!0,E=!1;try{for(var H,I,G=z[Symbol.iterator]();!(D=(H=G.next()).done)&&(I=H.value,!(I&&"object"===("undefined"==typeof I?"undefined":_typeof(I))));D=!0);}catch(K){E=!0,F=K}finally{try{!D&&G.return&&G.return()}finally{if(E)throw F}}if(I){if("id"in I)for(var J=0;J<z.length;J++)if(z[J]&&z[J].id==A)return m.get(z,J);return z.map(function(K){return m.get(K,A)})}}return null},first:function(z){return z&&z[0]||""},last:function(z){return z&&z[z.length-1]||""},unique:function(z){return Array.isArray(z)?[].concat(_toConsumableArray(new Set(z))):z},intersects:function(z,A){if(z&&A)return A=new Set(A),!z.every(function(B){return A.has(B)})},sum:function(z){return g(z,arguments).reduce(function(A,B){return+A+(+B||0)},0)},average:function(z){return z=g(z,arguments),z.length&&m.sum(z)/z.length},min:function(z){return Math.min.apply(Math,_toConsumableArray(g(z,arguments)))},max:function(z){return Math.max.apply(Math,_toConsumableArray(g(z,arguments)))},count:function(z){return Mavo.toArray(z).filter(function(A){return null!==A&&!1!==A&&""!==A}).length},round:function(z,A){return z&&A&&isFinite(z)?+z.toLocaleString("en-US",{useGrouping:!1,maximumFractionDigits:A}):Math.round(z)},th:function(z){if(null===z||""===z)return"";if(10>A||20<A)var A=["th","st","nd","th"][z%10];return A=A||"th",z+A},iff:function(z,A){var B=2<arguments.length&&void 0!==arguments[2]?arguments[2]:"";return Array.isArray(z)?z.map(function(C,D){var E=C?A:B;return Array.isArray(E)?E[Math.min(D,E.length-1)]:E}):z?A:B},replace:function(z,A){var B=2<arguments.length&&void 0!==arguments[2]?arguments[2]:"",C=3<arguments.length&&void 0!==arguments[3]?arguments[3]:1;if(Array.isArray(z))return z.map(function(H){return m.replace(H,A,B)});for(var F,D=RegExp(Mavo.escapeRegExp(A),"g"),E=z,G=0;E!=F&&G++<C;)F=E,E=E.replace(D,B);return E},len:function(z){return h(z).length},search:function(z,A){return z&&A?h(z).toLowerCase().indexOf((A+"").toLowerCase()):-1},starts:function(z,A){return 0===m.search(h(z),h(A))},ends:function(z,A){var B=[h(z),h(A)];z=B[0],A=B[1];var C=m.search(z,A);return-1<C&&C===z.length-A.length},join:function(z,A){return Mavo.toArray(z).join(h(A))},idify:function(z){return h(z).replace(/\s+/g,"-").replace(/[^\w-]/g,"").toLowerCase()},readable:function(z){return h(z).replace(/([a-z])([A-Z])(?=[a-z])/g,function(A,B,C){return B+" "+C.toLowerCase()}).replace(/([a-z0-9])[_\/-](?=[a-z0-9])/g,"$1 ").replace(/^[a-z]/,function(A){return A.toUpperCase()})},uppercase:function(z){return h(z).toUpperCase()},lowercase:function(z){return h(z).toLowerCase()},from:function(z,A){return m.between(z,A)},fromlast:function(z,A){return m.between(z,A,"",!0)},to:function(z,A){return m.between(z,"",A)},tofirst:function(z,A){return m.between(z,"",A,!0)},between:function(z,A,B,C){var D=[h(z),h(A),h(B)];z=D[0],A=D[1],B=D[2];var E=A?z[C?"lastIndexOf":"indexOf"](A):-1,F=z[C?"indexOf":"lastIndexOf"](B);return z.slice(E+1,-1!==F&&B?F:z.length)},filename:function(z){return Mavo.match(new URL(z||"",Mavo.base).pathname,/[^/]+?$/)},json:function(z){return Mavo.safeToJSON(z)},get $now(){return new Date},get $today(){return m.date(new Date)},year:l("year"),month:l("month"),day:l("day"),weekday:l("weekday"),hour:l("hour"),minute:l("minute"),second:l("second"),date:function(z){return m.year(z)+"-"+m.month(z).twodigit+"-"+m.day(z).twodigit},time:function(z){return m.hour(z).twodigit+":"+m.minute(z).twodigit+":"+m.second(z).twodigit},minutes:function(z){return Math.floor(Math.abs(z)/60)},hours:function(z){return Math.floor(Math.abs(z)/3600)},days:function(z){return Math.floor(Math.abs(z)/86400)},weeks:function(z){return Math.floor(Math.abs(z)/604800)},months:function(z){return Math.floor(Math.abs(z)/(30.4368*86400))},years:function(z){return Math.floor(Math.abs(z)/(12*(30.4368*86400)))},localTimezone:-new Date().getTimezoneOffset(),log:function(){var z;return(z=console).log.apply(z,arguments),0>=arguments.length?void 0:arguments[0]}};for(var q in f.lazy(Mavo.Functions,"$url",function(){var C,y={},z=new URL(location),A=!0,B=!1;try{for(var E,F,D=z.searchParams[Symbol.iterator]();!(A=(E=D.next()).done);A=!0)F=E.value,y[F[0]]=F[1]}catch(G){B=!0,C=G}finally{try{!A&&D.return&&D.return()}finally{if(B)throw C}}return Object.defineProperties(y,{path:{value:z.pathname.split("/").filter(function(G){return!!G})},toString:{value:function(){return new URL(location)}}}),y}),Mavo.Script={addUnaryOperator:function(z,A){return function(B){return Array.isArray(B)?B.map(A.scalar):A.scalar(B)}},addBinaryOperator:function(z,A){if(A.symbol){var D,B=!0,C=!1;try{for(var F,G,E=Mavo.toArray(A.symbol)[Symbol.iterator]();!(B=(F=E.next()).done);B=!0)G=F.value,Mavo.Script.symbols[G]=z}catch(H){C=!0,D=H}finally{try{!B&&E.return&&E.return()}finally{if(C)throw D}}}return A.identity=void 0===A.identity?0:A.identity,m[z]=A.code||function(){for(var H=arguments.length,I=Array(H),J=0;J<H;J++)I[J]=arguments[J];1===I.length&&Array.isArray(I[0])&&(I=[].concat(_toConsumableArray(I[0])));for(var L,K=A.logical?A.identity:I[0],M=function(P){var Q=A.logical?I[P-1]:K,R=I[P];Array.isArray(R)?("number"==typeof A.identity&&(R=g(R)),L=Array.isArray(Q)?[].concat(_toConsumableArray(R.map(function(S,T){return A.scalar(void 0===Q[T]?A.identity:Q[T],S)})),_toConsumableArray(Q.slice(R.length))):R.map(function(S){return A.scalar(Q,S)})):Array.isArray(Q)?L=Q.map(function(S){return A.scalar(S,R)}):L=A.scalar(Q,R),K=A.reduce?A.reduce(K,L,Q,R):A.logical?K&&L:L},N=1;N<I.length;N++)M(N);return K}},symbols:{},getOperatorName:function(z){return Mavo.Script.symbols[z]||z},operators:{not:{scalar:function(){return function(A){return!A}}},multiply:{scalar:function(z,A){return z*A},identity:1,symbol:"*"},divide:{scalar:function(z,A){return z/A},identity:1,symbol:"/"},add:{scalar:function(z,A){return+z+ +A},symbol:"+"},subtract:{scalar:function(z,A){if(isNaN(z)||isNaN(A)){var B=j(z),C=j(A);if(B&&C)return(B-C)/1e3}return z-A},symbol:"-"},mod:{scalar:function(z,A){var B=z%A;return B+=0>B?A:0,B}},lte:{logical:!0,scalar:function(z,A){var B=Mavo.Script.getNumericalOperands(z,A),C=_slicedToArray(B,2);return z=C[0],A=C[1],z<=A},identity:!0,symbol:"<="},lt:{logical:!0,scalar:function(z,A){var B=Mavo.Script.getNumericalOperands(z,A),C=_slicedToArray(B,2);return z=C[0],A=C[1],z<A},identity:!0,symbol:"<"},gte:{logical:!0,scalar:function(z,A){var B=Mavo.Script.getNumericalOperands(z,A),C=_slicedToArray(B,2);return z=C[0],A=C[1],z>=A},identity:!0,symbol:">="},gt:{logical:!0,scalar:function(z,A){var B=Mavo.Script.getNumericalOperands(z,A),C=_slicedToArray(B,2);return z=C[0],A=C[1],z>A},identity:!0,symbol:">"},eq:{logical:!0,scalar:function(z,A){return z==A},symbol:["=","=="],identity:!0},neq:{logical:!0,scalar:function(z,A){return z!=A},symbol:["!="],identity:!0},and:{logical:!0,scalar:function(z,A){return!!z&&!!A},identity:!0,symbol:"&&"},or:{logical:!0,scalar:function(z,A){return z||A},reduce:function(z,A){return z||A},identity:!1,symbol:"||"},concatenate:{symbol:"&",identity:"",scalar:function(z,A){return""+(z||"")+(A||"")}},filter:{scalar:function(z,A){return A?z:null}}},getNumericalOperands:function(z,A){if(isNaN(z)||isNaN(A)){var B=j(z),C=j(A);if(B&&C)return[B,C]}return[z,A]}},Mavo.Script.operators){var s=Mavo.Script.operators[q];2>s.scalar.length?Mavo.Script.addUnaryOperator(q,s):Mavo.Script.addBinaryOperator(q,s)}var t={average:"avg",iff:"iff IF",subtract:"minus",multiply:"mult product",divide:"div",lt:"lessThan smaller",gt:"moreThan greater greaterThan bigger",eq:"equal equality",th:"ordinal"},u=function(z){t[z].split(/\s+/g).forEach(function(A){return m[A]=m[z]})};for(var v in t)u(v);Mavo.Functions._Trap=self.Proxy?new Proxy(m,{get:function(z,A){var B,C=Mavo.getCanonicalProperty(z,A)||Mavo.getCanonicalProperty(Math,A);return C&&(B=z[C]||Math[C]),B?(B.toString=function(){return A},B):A in self?self[A]:A},has:function(z,A){return"data"!=A}}):Mavo.Functions;var w=new Intl.NumberFormat("en",{minimumIntegerDigits:"2"});w=w.format.bind(w);var x={year:function(z){return z.getFullYear()},month:function(z){return z.getMonth()+1},day:function(z){return z.getDate()},weekday:function(z){return z.getDay()||7},hour:function(z){return z.getHours()},minute:function(z){return z.getMinutes()},second:function(z){return z.getSeconds()}}})(Bliss);
